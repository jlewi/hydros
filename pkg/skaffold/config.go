...
// https://github.com/GoogleContainerTools/skaffold/blob/main/pkg/skaffold/schema/v3/config.go
// We vendor it in to avoid having to depend on the entire skaffold package which leads to dependency issues.
